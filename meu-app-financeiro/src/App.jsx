...
const LG_STYLES = `
  ...
  /* FUNDO CLARO — gradiente cinza neutro animado */
  .lg-bg {
  ...
  .lg-card {
    ...
    box-shadow:
      ...
      inset 0 -1px 0 rgba(200,200,200,0.25);
    border-radius: 24px;
    position: relative;
    overflow: hidden;
  }
  ...
  .lg-btn-dark {
    background: linear-gradient(135deg, rgba(55,65,81,0.92) 0%, rgba(31,41,55,0.95) 100%);
    border: 1px solid rgba(156,163,175,0.3);
    box-shadow: 0 4px 16px rgba(0,0,0,0.18), inset 0 1px 0 rgba(255,255,255,0.15);
    color: white;
  }
  .lg-btn-secondary {
    ...
    color: #374151;
    box-shadow: inset 0 1px 0 rgba(255,255,255,0.9), 0 2px 6px rgba(0,0,0,0.05);
  }
  .lg-btn-destructive {
  ...
  .lg-input {
    ...
    border: 1px solid rgba(180,180,185,0.55) !important;
  ...
  .lg-input:focus {
    ...
    box-shadow: 0 0 0 3px rgba(107,114,128,0.1), inset 0 1px 0 rgba(255,255,255,0.9) !important;
    outline: none;
  }
  ...
  .lg-divider        { background: rgba(200,200,200,0.5); }

  /* HEADER DO PERFIL */
  .lg-profile-header {
    background: linear-gradient(135deg,
      rgba(243,244,246,0.98) 0%,
      rgba(233,234,236,0.98) 50%,
  ...
  .lg-avatar-ring {
    ...
    box-shadow: 0 0 0 3px rgba(156,163,175,0.15), 0 4px 16px rgba(0,0,0,0.12);
  }
  ...
  /* FITA */
  .lg-fita-track { background: rgba(200,200,200,0.35); }
  ...
  return (
    <>
      <button onClick={() => setIsOpen(!isOpen)} className="fixed bottom-6 right-6 z-[300] size-14 rounded-full flex items-center justify-center active:scale-90 transition-transform"
        style={{ background: "linear-gradient(135deg, rgba(55,65,81,0.95) 0%, rgba(31,41,55,0.98) 100%)", border: "2px solid rgba(156,163,175,0.45)", boxShadow: "0 8px 32px rgba(0,0,0,0.18), inset 0 1px 0 rgba(255,255,255,0.12)" }}>
