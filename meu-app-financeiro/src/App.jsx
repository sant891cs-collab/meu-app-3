      ...
      <div className="flex-shrink-0 pt-14 px-3 sm:px-6 max-w-6xl mx-auto w-full">
        ...
        <Card className="rounded-3xl border border-slate-200/70 bg-white shadow-[0_12px_30px_rgba(15,23,42,0.06)] overflow-hidden mb-2">
          <CardContent className="grid gap-2 p-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              <Button onClick={() => registrarMovimentoManual("receita")} className="bg-emerald-500 text-white hover:bg-emerald-600 shadow-sm rounded-2xl py-1.5 text-sm">
                Adicionar Receita
              </Button>
              <Button onClick={() => registrarMovimentoManual("despesa")} className="bg-rose-500 text-white hover:bg-rose-600 shadow-sm rounded-2xl py-1.5 text-sm">
                Adicionar Despesa
              </Button>
            </div>
          </CardContent>
                    ...
                    <div key={l.id} className="rounded-xl bg-slate-50 p-2 flex justify-between items-center">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex gap-1">
                          ...
                          <Button variant="destructive" className="bg-rose-400 hover:bg-rose-500 text-white border-none px-2 py-1 text-xs" onClick={() => excluirLancamento(l.id)}>Excluir</Button>
                        </div>
                      </div>
                    </div>
                  ))}
        ...
        <div className="fixed inset-0 z-[280] bg-black/50 flex items-center justify-center p-4">
          <div className="w-full max-w-md bg-white rounded-2xl p-5 shadow-2xl space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2 pt-1">
              ...
              <Button variant="destructive" onClick={excluirConta} className="flex-1 bg-red-600 hover:bg-red-700 text-white text-sm">Sim, excluir</Button>
            </div>
          </div>
        </div>
      )}
